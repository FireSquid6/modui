...
function __modui_check_hover(_x1,_y1,_x2,_y2)
{
	var ret=false
...
function __modui_check_clicked(_hover)
{
...
//get mouse pos
function __modui_get_mouse_pos(_drawType)
{
	switch _drawType
	{
...
function modui_system(_selectionType) constructor
{
